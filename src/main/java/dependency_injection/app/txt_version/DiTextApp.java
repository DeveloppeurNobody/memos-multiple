package dependency_injection.app.txt_version;
...
import dependency_injection.dao.IDao;
import dependency_injection.dao.impl.DaoImpl;
import dependency_injection.metier.IMetier;
import dependency_injection.metier.impl.MetierImpl;
...
public class DiTextApp {
	...
	public void instantiateAsDynamiqueTechnique()
		...
		File file = Paths.get("src/main/java/dependency_injection/config.txt").toFile();
