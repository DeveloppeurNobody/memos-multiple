...
public class SecondAspect {
    ...
    //  *
    //  */
    // private static final String EXECUTION_COM_MYCOMPANY_DEMO_AOP_MY_MESSAGE_SHOW_MESSAGE = "execution(* aop.MyMessage.showMessage(..))";
    ...
    //@Pointcut("execution(* aop.metier.*.*(..))")

    //  /*
    //  * one specific class
    //  */
    // @Pointcut("within(aop.message.MyMessage)")
